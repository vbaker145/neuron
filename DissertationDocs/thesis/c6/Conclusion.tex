...
We have demonstrated traveling waves in quasi two-dimensional sheets.
We have shown that our model can exhibit circular spreading waves, plane waves and rotating or spiral waves.
The spiral waves are most prevalent at lower connection strengths.
Low-threshold-spiking inhibitory neurons can act as pacemakers in our model, spawning waves that can dominate the firing activity in a stable dynamic attractor state.

We have demonstrated traveling waves in a forest of minicolumns that represents the laminar and microcolumnar organization of the cortex.
