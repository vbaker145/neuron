...
This local connectivity model has been observed in the mouse visual cortex\citep{Hellwig2000} and auditory cortex\citep{Levy2012}.
...
An example of the clustering and identification is shown in Figure \ref{fig:wave_analysis}.
...
For the quasi two-dimensional sheets and forests we also visualize traveling waves with color plots of the membrane potential (see for example figure \ref{fig:2D_waves}).
...
\section{Spike correlation analysis}\label{sec:spike_correlation_analysis}
...
These measures were used by \citet{keane2015} to show that traveling waves could simultaneously explain both the irregular firing of individual neurons
