...
Computer simulations of such traveling waves are typically performed in strictly one-dimensional or two-dimensional excitations with homogeneous neurons and isotropic connectivity. 
Here we investigate the conditions for the existence of quasi one-dimensional traveling waves that could be sustainable in parts of the brain containing cortical minicolumns.
...
We find that a uniform random stimulus reliably evokes traveling waves in networks with local connectivity between neurons.
We also propose a role for traveling waves in quasi one-dimensional systems as an encoding and transport mechanism for neural population activity.
