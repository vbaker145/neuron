...
# $Revision: 1.4 $  $Date: 2006/05/27 17:56:46 $
#----------------------------------------------------------------------------
#
    #TMW_ROOT="$MATLAB"
...
#            CLIBS="$RPATH $MLIBS -lm -nodefaultlibs /usr/local/lib/libstdc++.a -lgcc_s"
...
#           Add -fhandle-exceptions to CXXFLAGS to support exception handling
            ...
            #CXXLIBS="$RPATH $MLIBS -lm -nodefaultlibs /usr/local/lib/libstdc++.a -lgcc_s"
            CXXLIBS="$RPATH $MLIBS -lm -nodefaultlibs /usr/lib/libstdc++.a -lgcc_s"
            CXXOPTIMFLAGS='-O -DNDEBUG'
            CXXDEBUGFLAGS='-g'
#
#           g77 -v -xf77-version
