...
%% Stimulate base column, plot firing activity
...
%% Single strong inhibitory neuron test
connectivity.percentExc = 40*structure.width*structure.height; %Single LTS inhibitory neuron
