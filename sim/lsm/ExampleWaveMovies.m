...
for jj=1:10
    ...
    for kk=1:10
        ...
        hbins = hbins + bins;
        figure; plot(firings(:,1)./1000,firings(:,2)./4,'k.');
        h = figure; 
        set(h, 'Position', [680 558 400 900])
        mv = plotColumn(2, 2, 100, vall, 'BackgroundStimVideo');
        ...
        h = figure; 
        set(h, 'Position', [680 558 400 900])
        mv = plotColumn(2, 2, 100, vall, 'StepStimVideo');
