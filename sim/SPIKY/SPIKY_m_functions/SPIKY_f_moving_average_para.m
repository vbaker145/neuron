% This function calculates the moving average (including values from both past and future)
...
function z=SPIKY_f_moving_average_para(y,o)

% past+future, inwards averaging at the edges (asymmetric), calculates many rows in parallel, order of moving average o = window length
