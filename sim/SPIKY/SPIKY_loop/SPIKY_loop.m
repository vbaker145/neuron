...
dataset=4;            % 1-Frequency mismatch,2-Spiking events,3-Splay state vs. identical,4:Test
...
para.select_measures      =[0 0 0 0 0 0 0];  % Select measures (0-calculate,1-do not calculate)
