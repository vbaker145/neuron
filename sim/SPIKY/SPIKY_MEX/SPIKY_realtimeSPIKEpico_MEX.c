...

{
    ...
    double *bi_spike_diffs_realtime_t, *udists, *udists2, *isi, *cum_isi, *prev_spikes;
    ...
    mxSetData(bi_spike_diffs_realtime_t_out, mxMalloc(sizeof(double) * *num_pairs * *run_pico_lengths_ruc));
