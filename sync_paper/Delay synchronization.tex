...
Using a common time step and a sufficient number of Monte Carlo trials ensures that the measured relationships are valid, i.e. the dependence of propagation velocity on column topology.
