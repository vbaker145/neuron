...
\color{red}In  \parencite{Markram1997} a latency of $1.7\pm 0.9\ ms$ was observed between injecting a stimulus in one pyramidal neuron and the resulting excitatory post-synpatic potential in an adjacent pyramidal neuron.
...
We first simulate the SCE with a fixed action potential propagation delay of \color{red}$1.9~ms$ \parencite{Markram1997} \color{black} regardless of inter-neuron distance.
...
\begin{figure}[!htb]
 \caption{With global connectivity and action potential propagation delay \color{red}fixed at 1.9 ms\color{black}, the entire structure shows synchronized firing events.
          \color{red}
