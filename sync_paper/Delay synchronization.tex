...
A second key element, namely neuron dynamics, will also influence wave propagation speed.
...
For $\lambda<2.25$ traveling waves were not observed.
\begin{figure}[!htb]
...
We then measured the fraction of wave initiation events (FIE) per unit length of the SCE.
...
By combining these two experiments we observed that the results from the FIE and the FFE appeared anti-correlated for the same SCE (see Supplemental Information for examples).
