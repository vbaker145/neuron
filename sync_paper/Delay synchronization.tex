...
We replicated this simulation by setting our column to have complete connectivity corresponing to $\lambda \rightarrow \infty$: all neurons are connected wiht probability 1 to all other neurons.
...
The $\kappa$ parameter was set to 1.
