...
We also tested the $1x1$ topology but found that it did not support traveling waves \color{red}(SI Figure 6)\color{black}.
...
This is generally slower than other computational results, but the \color{red}mid to upper range \color{black}is of the same order of magnitude as the experimental velocity of \color{red}$50~mm/s$ \color{black} reported in \parencite{Golomb1997}.
