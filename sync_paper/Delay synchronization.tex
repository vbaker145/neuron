...
Because here we focus on traveling waves in the Z direction, so we plot the spikes according to the Z position of the neurons.
...
This is generally slower than other computational results, but the mid to upper range is of the same order of magnitude as the experimental velocity of \color{red}$50~mm/s$ \color{black} reported in \parencite{Golomb1997}.
