...
In our experiments we observe an anti-correlation between the FIE and the FFE for an SCE (see Supplemental Information for examples).
To test that this observation is generally true we create 100 SCEs, applied first uniform background stimulus and then step stimulus to each SCE, and measured the FIE and FFE (Figure \ref{fig:InitiationCorrelation}).
