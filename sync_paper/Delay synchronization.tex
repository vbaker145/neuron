...
We investigate the initiation of traveling waves from a uniform background stimulus (\ref{sub:wave_initiation}).
Finaly, we show that traveling waves in an ensemble of several columns (\ref{sub:column_ensembles}). 
...
\begin{table}[!h]
 ...
 \centering
 \begin{tabularx}{\textwidth}{l | c | c | X | c | c | c | r}
  \textbf{Section} & \textbf{NSim} & \textbf{Topology} & \textbf{$\lambda$} & \textbf{E/I} & \textbf{M} & \textbf{K} & \textbf{$\kappa$} \\
  \hline
  a & $100$ & $2x2x100$ & $2.5$ & $80\%$ & $5$ & $2-6$ & $1$ \\ 
  b & $100$ & $2x2x100$ & $\infty$ & $80\%$ & $5$ & $5$ & $0,1$ \\ 
  c & $100$ & $2x2x100$ & $2.5$ & $0-100\%$ & $5$ & $5$ & $1$ \\ 
  d & $100$ & $(2x2,3x3)x100$ & $2.5$ & $80\%$ & $5$ & $5$ & $1-5$ \\ 
  e & $100$ & $2x2x100$ & $2.5$ & $80\%$ & $5$ & $5$ & $1$ \\ 
  f & $100$ & Four columns & $2.5$ & $80\%$ & $5$ & $5$ & $1$ \\ 
 \end{tabularx}
\end{table}
...
\subsection{Column ensembles} \label{sub:column_ensembles}
