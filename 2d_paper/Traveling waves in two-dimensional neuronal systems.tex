...
\begin{figure}[!htb]
 \caption{Example of wave analysis.
     ...
     \subfloat[][]{\includegraphics[width=\textwidth]{fig/WavePropTest_Rasters} } \\
     \subfloat[][]{\includegraphics[width=0.48\textwidth]{fig/WavePropTest_SpikeDelays} }
     \subfloat[][]{\includegraphics[width=0.48\textwidth]{fig/WavePropTest_AngleFittingError} }
...
\begin{figure}[!htb]
 \caption{Wave visualized as a vector field.
     ...
     \subfloat[][]{\includegraphics[width=0.39\textwidth]{fig/WavePropTest_Quiver} }
     \subfloat[][]{\includegraphics[width=0.59\textwidth]{fig/WavePropTest_QuiverEvolution} }
...
\begin{figure}[!htb]
 ...
 \centering
   ...
   \subfloat[][]{\includegraphics[width=\textwidth]{fig/2DSpiralVectorField} }\\
   \subfloat[][]{\includegraphics[width=\textwidth]{fig/2DSpiralWaveSpeedDistribution} }
\end{figure}
\FloatBarrier
